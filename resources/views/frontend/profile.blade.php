        ...
        <div class="profile">
            ...
            <div class="card">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="100%">
                        ...
                        <defs>
                            <linearGradient id="a" gradientUnits="userSpaceOnUse" x1="0" x2="0"
                                ...
                                <stop offset="0" stop-color="#9CCD62"></stop>
                                <stop offset="1" stop-color="#12e365"></stop>
                            </linearGradient>
                ...
                <div class="card__avatar"><svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="64" cy="64" fill="#F6F8E2;" opacity=".4" r="48"></circle>
                        ...
                        <path d="m64 88.75v9.75" fill="none" stroke="#fbc0aa" stroke-linecap="round"
                            stroke-linejoin="round" stroke-width="14"></path>
                        <circle cx="39" cy="65" fill="#fbc0aa" r="7"></circle>
                        <path d="m64 91a25 25 0 0 1 -25-25v-16.48a25 25 0 1 1 50 0v16.48a25 25 0 0 1 -25 25z"
                            fill="#ffd8c9"></path>
                        <path
                        ...
                        <ellipse cx="50.42" cy="69.67" fill="#f85565" opacity=".1" rx="4.58"
                            ry="2.98"></ellipse>
                        <ellipse cx="77.58" cy="69.67" fill="#f85565" opacity=".1" rx="4.58"
                            ry="2.98"></ellipse>
